...
{
  VER_TO_INSTALL=$1
  PLAY_URL="https://github.com/larvalabs/play1/releases/download/1.5.3.larva/play-1.5.x-1.5.3.larva.tar.gz"
  ...
  if [ "$status" != "200" ]; then
    ...
    echo "-----> Successfully downloaded $VER_TO_INSTALL from Github....."
